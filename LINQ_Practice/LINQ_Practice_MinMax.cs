...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_MinMax //.Min & .Max
    {
        ...
        {
            var minValue = PracticeData[2].Students.Min(s => s.Birthday);/*FILL IN LINQ EXPRESSION*/; //HINT: Cohort3 is PracticeData[2]
        ...
        {
            var maxValue = PracticeData.Max(j => j.JuniorInstructors.Count());/*FILL IN LINQ EXPRESSION*/
