...
namespace LINQ_Practice
{
        ...
        */
    {
        ...
        {
            var ActualCohort = PracticeData.Single(j => j.JuniorInstructors.Count() == 3);
        ...
        {
            var ActualCohort = PracticeData.Single(c => c.FullTime == true && c.PrimaryInstructor.Birthday.Year > 2016);
